...
void maquinaDeEstados()
{
    ...
    switch (estado)
    {
        ...
        case ESTADO_ENCENDIDO:
        {
            ...
            switch (tipo_evento)
            {
                case TIPO_EVENTO_CONTINUE: case TIPO_EVENTO_ABRIR_PUERTA: case TIPO_EVENTO_CERRAR_PUERTA: case TIPO_EVENTO_TIMEOUT:
                {
                    estado = ESTADO_ENCENDIDO;
                    tipo_evento = TIPO_EVENTO_CONTINUE;
                }
        ...
        case ESTADO_PAUSADO:
        {
            switch (tipo_evento)
            {
              ...
              break;
              case TIPO_EVENTO_PRESIONA_REANUDAR: case TIPO_EVENTO_PRESIONA_PAUSA:
                if(estado_puerta == PUERTA_ABIERTA)
                {
                  cambiarEstadoPuerta();
                }
